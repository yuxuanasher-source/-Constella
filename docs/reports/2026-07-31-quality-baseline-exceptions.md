...
- Critical-domain coverage: the corrected gate includes Markdown, billing
  ...
  per-file thresholds pass with aggregate statements 97.42%, branches 90.45%,
  functions 100%, and lines 98.10%.
