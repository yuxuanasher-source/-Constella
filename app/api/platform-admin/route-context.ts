...
import { createSupabasePlatformAdminPaymentRepository } from "@/features/platform-admin/platform-admin-payment-repository-supabase";
...
export async function getPlatformAdminRouteContext() {
  ...
  return {
    ...
    paymentRepo: createSupabasePlatformAdminPaymentRepository(admin),
  };
}
